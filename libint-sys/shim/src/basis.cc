...
namespace libint2 {
std::unique_ptr<BasisSet> basis(rust::Str name, const Atom *const *atoms,
                                size_t n) {
...
std::size_t nshells(const BasisSet &basis) { return basis.size(); }

std::size_t nbf(const BasisSet &basis) { return basis.nbf(); }

std::size_t max_nprim(const BasisSet &basis) { return basis.max_nprim(); }

std::size_t max_l(const BasisSet &basis) { return basis.max_l(); }
